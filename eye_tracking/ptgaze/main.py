...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--camera",
        type=str,
        help="Camera calibration file. " "See https://github.com/hysts/pytorch_mpiigaze_demo/ptgaze/data/calib/sample_params.yaml",
    )
    parser.add_argument("--output-dir", "-o", type=str, help="If specified, the overlaid video will be saved to this directory.")
    parser.add_argument("--ext", "-e", type=str, choices=["avi", "mp4"], help="Output video file extension.")
    parser.add_argument(
        "--no-screen", action="store_true", help="If specified, the video is not displayed on screen, and saved " "to the output directory."
    )
