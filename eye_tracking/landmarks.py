...
landmark_mapping = {
    ...
    "upper_eyelid_right": {
        "colour": CM.royal_blue,
        "points": [398, 384, 385, 386, 387, 388, 263, 359],
    },
    "lower_eyelid_left": {
        "colour": CM.royal_blue,
    ...
    "lower_eyelid_right": {
        "colour": CM.royal_blue,
        "points": [249, 255, 373, 390],
    },
    "under_eye_left": {
        "colour": CM.cornflower_blue,
        "points": [31, 228, 229, 230, 231, 232, 233, 244, 120, 121, 128, 245, 100, 47, 114, 188],
    },
    "under_eye_right": {
        "colour": CM.cornflower_blue,
        "points": [
    ...
    "eyesocket_outside_right": {"colour": CM.coral, "points": [265, 446, 342, 353]},
    "above_eye_left": {"colour": CM.white, "points": [225, 224, 223, 222, 221, 189]},
    "above_eye_right": {"colour": CM.white, "points": [441, 286, 442, 258, 443, 257, 259, 444, 260, 445, 467]},
    "lips": {
        "colour": CM.yellow,
        "points": [
            39,
